...
const ServicesPage = () => {
  const services = [
    {
      ...
      description:
        "We enhance workforce skills through targeted training and professional development ...",
      image: "/s1.webp", // Replace with actual image
    },
    {
      title: "Technology Integration",
      description:
        "We integrate advanced technology solutions to optimize operations and drive innovation ...",
      image: "/s2.webp",
    },
    {
      title: "Marketing Strategy",
      description:
        "Our marketing strategies drive brand awareness, customer engagement, and business growth ...",
      image: "/s3.webp",
    },
    {
      title: "Strategic Planning",
      description:
        "Our strategic planning ensures sustainable growth and long-term success for your business ...",
      image: "/s4.webp",
    },
    {
      title: "Financial Consulting",
      description:
        "We provide expert financial consulting to maximize profitability and ensure fiscal stability ...",
      image: "/s5.webp",
    },
    {
      title: "Operational Optimization",
      description:
        "We optimize operations to enhance efficiency, reduce costs, and improve performance ...",
      image: "/s6.webp",
    },
  ];
  ...
  const achievements = [
    {
      title: "Excellence Recognizing",
      subtitle: "Design Awards – Innovation",
      year: "2018",
    },
    {
  ...
  return (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl">
            {services.map((service, index) => (
              ...
              >
                ...
                <button
                  className="absolute right-[2%] bottom-[25%]  text-[#C59740] text-2xl font-bold h-12 w-12 flex items-center justify-center p-4 rounded-full border-2 border-[#C59740] 
          transition-transform duration-300 ease-in-out hover:bg-[#C59740] hover:text-white hover:rotate-45 hover:scale-105 active:scale-95 
    "
                >
                  <span className="material-icons transform rotate-[320deg]">
                    →
                  </span>
                </button>
              </div>
    ...
    Browse All Services 
          ...
          <Link to="/services" className="inline-block">
            <button className="mt-6 px-6 py-3 bg-[#C59740] text-white rounded-lg hover:bg-[#C59740] ">
              Browse All Services
            </button>
          </Link>
        </div>
          ...
          <div className="w-full md:w-1/2 ">
            ...
            <div className="space-y-8">
              ...
              <div className="relative">
                <span className="absolute left-[-9%] top-[-23%] text-6xl text-gray-200 font-bold">
                  01
                </span>
                <div className="ml-12">
                  <h4 className="text-lg font-semibold text-[#C59740]">
                    DISCUSSIONS ABOUT PROJECT
                  </h4>
                  <p className="text-gray-300 mt-1">
                    Forging relationships between multinational corporations,
              ...
              <div className="relative">
                ...
                <div className="ml-12">
                  ...
                  <p className="text-gray-300 mt-1">
                    ...
                    and became a multinational firm.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="ml-12">
                  ...
                  <p className="text-gray-300 mt-1">
                    ...
                    integrally and believe in the power.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="min-h-screen flex items-center justify-center px-10  ">
          <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-1">
            ...
            <div className="relative flex flex-col justify-center top-[-70%]">
              ...
              <h2 className="text-4xl font-bold mt-2 text-[#C59740]">
