...
const ProjectsHeader = () => {
  return (
    <div className="max-w-6xl mx-auto px-4 py-16 text-center">
      <a
        href="#"
        className="inline-block mb-6 text-gray-600 hover:text-gray-300 underline"
      >
...
const projects = [
  {
    ...
    description:
      "Our customer focus delivers personalized service, ensuring satisfaction and fostering long-term relationships.",
...
const ProjectList = () => {
  ...
  const getImageClasses = (projectId) => {
    const baseClasses =
      "w-full object-cover grayscale hover:grayscale-0 transition-all duration-500";
          ...
          >
            ...
            >
              <div className="flex items-start">
                <span className="text-[#C59740] text-sm whitespace-nowrap">
                  S / {project.id}
                </span>
