      ...
      >
        <div className="flex items-center gap-2 sm:gap-3">
          <div className="p-1.5 sm:p-2 bg-gray-900 rounded-lg group-hover:bg-teal-600 transition-colors">
            {label === "Locations" && (
              <MapPin className="w-4 h-4 sm:w-5 sm:h-5 text-teal-400 group-hover:text-white" />
            )}
            {label === "Job Type" && (
              <Briefcase className="w-4 h-4 sm:w-5 sm:h-5 text-teal-400 group-hover:text-white" />
            )}
            {label === "Salary" && (
              <DollarSign className="w-4 h-4 sm:w-5 sm:h-5 text-teal-400 group-hover:text-white" />
            )}
            {label === "Working Days" && (
              <Calendar className="w-4 h-4 sm:w-5 sm:h-5 text-teal-400 group-hover:text-white" />
            )}
          </div>
        ...
        <div className="flex flex-col lg:flex-row gap-6 lg:gap-8">
          ...
          <div className="flex-1 order-2 lg:order-1">
            ...
            <p className="text-gray-300 mb-6 sm:mb-8 leading-relaxed text-sm sm:text-base">
              A Construction Manager oversees and coordinates construction
              projects from inception <br></br>to completion, ensuring they are
              finished on time, within budget, and to high quality <br></br>{" "}
              standards. They manage a diverse team of professionals, including
              architects, engineers, <br></br> and subcontractors, and handle
              tasks such as project planning, resource allocation, and <br></br>
              problem-solving. Effective communication and leadership skills are
              essential as they<br></br> negotiate contracts, ensure compliance
              with regulations.
            </p>
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-2">
                  ...
                  <span className="text-gray-300 text-sm sm:text-base">
                    ...
                    off,flexible spending accounts.
                  </span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-[#C59740] mt-2">•</span>
