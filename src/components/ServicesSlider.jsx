      ...
      {sections.map((section) => (
        ...
        >
          <div className="relative h-full w-full flex flex-col lg:flex-row items-center">
            ...
            <div
              className="absolute left-1/2 -translate-x-1/2 lg:left-1/2 lg:top-1/2 lg:-translate-y-1/2 bottom-4 lg:bottom-auto 
              ...
              <div className="h-full flex items-center py-12 lg:py-0">
                <div className="px-6 md:px-8 lg:px-12 max-w-xl mx-auto">
                  <div>
                    ...
                    <button
                      className="w-full sm:w-auto bg-transparent hover:bg-cyan-400 text-cyan-400 
